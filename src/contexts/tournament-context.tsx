...
interface TournamentContextType {
  ...
  // Score actions
  setScore: (matchId: string, teamId: string, kills: number, placement: number, userId?: string, dayType?: 'br-shortlist' | 'br-championship' | 'cs-bracket', proofImageUrl?: string) => Promise<void>;
...
export function TournamentProvider({ children }: { children: React.ReactNode }) {
  ...
  // Score actions
  const setScore = useCallback(async (matchId: string, teamId: string, kills: number, placement: number, userId?: string, dayType?: 'br-shortlist' | 'br-championship' | 'cs-bracket', proofImageUrl?: string) => {
    return fbSetScore(matchId, teamId, kills, placement, userId, dayType, proofImageUrl);
  }, []);
